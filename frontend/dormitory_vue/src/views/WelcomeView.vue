  ...
  <div id="welcomebg">
    ...
    >
      <el-carousel-item
        ...
        :key="item.id"
        @click.native="handleImgClick(item.name)"
      >
        <img
          :src="item.idView"
          class="image"
    ...
    <el-row id="choose_btn">
      <el-button type="primary" @click="goCharacter">{{
        buttontext
      }}</el-button>
    </el-row>
  </div>
      ...
      imagebox: [
        {
          id: 0,
          name: "我是学生",
          idView: require("../assets/studentIcon.png"),
        },
        {
          id: 1,
          name: "我是宿管",
          idView: require("../assets/dormitoryStaff.png"),
        },
      ],
      buttontext: "我是学生",
    };
